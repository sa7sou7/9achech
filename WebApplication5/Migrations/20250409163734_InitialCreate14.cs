        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecteurActiv = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Cref = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Cnom = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CPrenom = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Commercials", x => x.Cref);
                    table.ForeignKey(
                        name: "FK_Commercials_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DocRef = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    TiersId = table.Column<int>(type: "int", nullable: false),
                    DocRepresentant = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    DocNetAPayer = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
